  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-lime/10 rounded-full blur-[150px] animate-float" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-lime/5 rounded-full blur-[120px] animate-float" style={{ animationDelay: '3s' }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-up">
        {showExpiredMessage && (
          <div className="mb-6 rounded-2xl border border-amber-300/20 bg-amber-300/10 px-6 py-4 text-xs font-bold uppercase tracking-widest text-amber-200 backdrop-blur-md text-center">
